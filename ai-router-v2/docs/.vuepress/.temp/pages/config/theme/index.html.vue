...
<p>主题配置用于定制主题的各项功能，以控制主题的行为，
您可以在 <code v-pre>.vuepress/config.ts</code> 或者 <code v-pre>.vuepress/plume.config.ts</code> 中进行配置。</p>
<p>当字段说明包含以下声明时，表示该字段不支持在 <code v-pre>.vuepress/plume.config.ts</code> 中进行配置：</p>
<div class="hint-container warning">
<p class="hint-container-title">该字段不支持在 <RouteLink to="/notes/theme/config/intro.html#%E4%B8%BB%E9%A2%98%E9%85%8D%E7%BD%AE%E6%96%87%E4%BB%B6">主题配置文件 <code v-pre>plume.config.js</code></RouteLink> 中进行配置。</p>
</div>
<p>无以上声明的字段，你可以在 <code v-pre>.vuepress/config.ts</code> 或者 <code v-pre>.vuepress/plume.config.ts</code> 的任意一个文件中
进行配置，一般情况下建议在 <code v-pre>.vuepress/plume.config.ts</code> 中进行配置。</p>
<div class="hint-container warning">
<p class="hint-container-title">已经在一个配置文件中进行配置的字段，尽量不要在另一个配置文件中重复配置</p>
</div>
<CodeTabs id="16" :data='[{"id":".vuepress/config.ts"},{"id":".vuepress/plume.config.ts"}]' tab-id="configs"><template #title0="{ value, isActive }"><VPIcon name="vscode-icons:file-type-typescript"/><span>.vuepress/config.ts</span></template><template #title1="{ value, isActive }"><VPIcon name="vscode-icons:file-type-typescript"/><span>.vuepress/plume.config.ts</span></template><template #tab0="{ value, isActive }"><div class="language-ts" data-highlighter="shiki" data-ext="ts" style="--shiki-light:#393a34;--shiki-dark:#dbd7caee;--shiki-light-bg:#ffffff;--shiki-dark-bg:#121212"><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code twoslash lsp"><code><span class="line"><span style="--shiki-light:#1E754F;--shiki-dark:#4D9375">import</span><span style="--shiki-light:#999999;--shiki-dark:#666666"> &#123;</span><span style="--shiki-light:#B07D48;--shiki-dark:#BD976A"> </span><span style="--shiki-light:#B07D48;--shiki-dark:#BD976A"><v-menu class="twoslash-hover" popper-class="shiki twoslash-floating vp-copy-ignore vp-code" theme="twoslash"><span>defineUserConfig</span><template v-slot:popper="&#123;}"><span class="twoslash-popup-container vp-copy-ignore" v-pre=""><code class="twoslash-popup-code"><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676">const </span><span style="--shiki-light:#59873A;--shiki-dark:#80A665">defineUserConfig</span><span style="--shiki-light:#999999;--shiki-dark:#666666">: (</span><span style="--shiki-light:#B07D48;--shiki-dark:#BD976A">config</span><span style="--shiki-light:#999999;--shiki-dark:#666666">: </span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994">UserConfig</span><span style="--shiki-light:#999999;--shiki-dark:#666666">) => </span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994">UserConfig</span></code></span></template></v-menu></span><span style="--shiki-light:#999999;--shiki-dark:#666666"> }</span><span style="--shiki-light:#1E754F;--shiki-dark:#4D9375"> from</span><span style="--shiki-light:#B5695977;--shiki-dark:#C98A7D77"> '</span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">vuepress</span><span style="--shiki-light:#B5695977;--shiki-dark:#C98A7D77">'</span></span>
<span class="line"><span style="--shiki-light:#1E754F;--shiki-dark:#4D9375">import</span><span style="--shiki-light:#999999;--shiki-dark:#666666"> &#123;</span><span style="--shiki-light:#B07D48;--shiki-dark:#BD976A"> </span><span style="--shiki-light:#B07D48;--shiki-dark:#BD976A"><v-menu class="twoslash-hover" popper-class="shiki twoslash-floating vp-copy-ignore vp-code" theme="twoslash"><span>plumeTheme</span><template v-slot:popper="&#123;}"><span class="twoslash-popup-container vp-copy-ignore" v-pre=""><code class="twoslash-popup-code"><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676">function</span><span style="--shiki-light:#59873A;--shiki-dark:#80A665"> plumeTheme</span><span style="--shiki-light:#999999;--shiki-dark:#666666">(</span><span style="--shiki-light:#B07D48;--shiki-dark:#BD976A">options</span><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676">?</span><span style="--shiki-light:#999999;--shiki-dark:#666666">: </span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994">ThemeOptions</span><span style="--shiki-light:#999999;--shiki-dark:#666666">):</span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994"> Theme</span></code></span></template></v-menu></span><span style="--shiki-light:#999999;--shiki-dark:#666666"> }</span><span style="--shiki-light:#1E754F;--shiki-dark:#4D9375"> from</span><span style="--shiki-light:#B5695977;--shiki-dark:#C98A7D77"> '</span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">vuepress-theme-plume</span><span style="--shiki-light:#B5695977;--shiki-dark:#C98A7D77">'</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#1E754F;--shiki-dark:#4D9375">export</span><span style="--shiki-light:#1E754F;--shiki-dark:#4D9375"> default</span><span style="--shiki-light:#59873A;--shiki-dark:#80A665"> </span><span style="--shiki-light:#59873A;--shiki-dark:#80A665"><v-menu class="twoslash-hover" popper-class="shiki twoslash-floating vp-copy-ignore vp-code" theme="twoslash"><span>defineUserConfig</span><template v-slot:popper="&#123;}"><span class="twoslash-popup-container vp-copy-ignore" v-pre=""><code class="twoslash-popup-code"><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676">function</span><span style="--shiki-light:#59873A;--shiki-dark:#80A665"> defineUserConfig</span><span style="--shiki-light:#999999;--shiki-dark:#666666">(</span><span style="--shiki-light:#B07D48;--shiki-dark:#BD976A">config</span><span style="--shiki-light:#999999;--shiki-dark:#666666">: </span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994">UserConfig</span><span style="--shiki-light:#999999;--shiki-dark:#666666">):</span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994"> UserConfig</span></code></span></template></v-menu></span><span style="--shiki-light:#999999;--shiki-dark:#666666">(&#123;</span></span>
<span class="line"><span style="--shiki-light:#998418;--shiki-dark:#B8A965">  </span><span style="--shiki-light:#998418;--shiki-dark:#B8A965"><v-menu class="twoslash-hover" popper-class="shiki twoslash-floating vp-copy-ignore vp-code" theme="twoslash"><span>theme</span><template v-slot:popper="&#123;}"><span class="twoslash-popup-container vp-copy-ignore" v-pre=""><code class="twoslash-popup-code"><span style="--shiki-light:#B07D48;--shiki-dark:#BD976A">theme</span><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676">?:</span><span style="--shiki-light:#B07D48;--shiki-dark:#BD976A"> Theme</span><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676"> |</span><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676"> undefined</span></code><div class="twoslash-popup-docs vp-doc" vp-content=""><p>Vuepress theme</p></div><div class="twoslash-popup-docs twoslash-popup-docs-tags vp-doc" vp-content=""><span class="twoslash-popup-docs-tag"><span class="twoslash-popup-docs-tag-name">@required</span></span></div></span></template></v-menu></span><span style="--shiki-light:#999999;--shiki-dark:#666666">: </span><span style="--shiki-light:#59873A;--shiki-dark:#80A665"><v-menu class="twoslash-hover" popper-class="shiki twoslash-floating vp-copy-ignore vp-code" theme="twoslash"><span>plumeTheme</span><template v-slot:popper="&#123;}"><span class="twoslash-popup-container vp-copy-ignore" v-pre=""><code class="twoslash-popup-code"><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676">function</span><span style="--shiki-light:#59873A;--shiki-dark:#80A665"> plumeTheme</span><span style="--shiki-light:#999999;--shiki-dark:#666666">(</span><span style="--shiki-light:#B07D48;--shiki-dark:#BD976A">options</span><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676">?</span><span style="--shiki-light:#999999;--shiki-dark:#666666">: </span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994">ThemeOptions</span><span style="--shiki-light:#999999;--shiki-dark:#666666">):</span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994"> Theme</span></code></span></template></v-menu></span><span style="--shiki-light:#999999;--shiki-dark:#666666">(&#123;</span></span>
<span class="line"><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD">    // 主题配置</span></span>
<span class="line"><span style="--shiki-light:#999999;--shiki-dark:#666666">  })</span></span>
<span class="line"><span style="--shiki-light:#999999;--shiki-dark:#666666">})</span></span></code></pre>
</div></template><template #tab1="{ value, isActive }"><div class="language-ts" data-highlighter="shiki" data-ext="ts" style="--shiki-light:#393a34;--shiki-dark:#dbd7caee;--shiki-light-bg:#ffffff;--shiki-dark-bg:#121212"><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code twoslash lsp"><code><span class="line"><span style="--shiki-light:#1E754F;--shiki-dark:#4D9375">import</span><span style="--shiki-light:#999999;--shiki-dark:#666666"> &#123;</span><span style="--shiki-light:#B07D48;--shiki-dark:#BD976A"> </span><span style="--shiki-light:#B07D48;--shiki-dark:#BD976A"><v-menu class="twoslash-hover" popper-class="shiki twoslash-floating vp-copy-ignore vp-code" theme="twoslash"><span>defineThemeConfig</span><template v-slot:popper="&#123;}"><span class="twoslash-popup-container vp-copy-ignore" v-pre=""><code class="twoslash-popup-code"><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676">function</span><span style="--shiki-light:#59873A;--shiki-dark:#80A665"> defineThemeConfig</span><span style="--shiki-light:#999999;--shiki-dark:#666666">(</span><span style="--shiki-light:#B07D48;--shiki-dark:#BD976A">config</span><span style="--shiki-light:#999999;--shiki-dark:#666666">: </span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994">ThemeConfig</span><span style="--shiki-light:#999999;--shiki-dark:#666666">):</span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994"> ThemeConfig</span></code><div class="twoslash-popup-docs vp-doc" vp-content=""><p>主题配置，在单独的 <code>plume.config.ts</code> 中使用的类型帮助函数</p></div></span></template></v-menu></span><span style="--shiki-light:#999999;--shiki-dark:#666666"> }</span><span style="--shiki-light:#1E754F;--shiki-dark:#4D9375"> from</span><span style="--shiki-light:#B5695977;--shiki-dark:#C98A7D77"> '</span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">vuepress-theme-plume</span><span style="--shiki-light:#B5695977;--shiki-dark:#C98A7D77">'</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#1E754F;--shiki-dark:#4D9375">export</span><span style="--shiki-light:#1E754F;--shiki-dark:#4D9375"> default</span><span style="--shiki-light:#59873A;--shiki-dark:#80A665"> </span><span style="--shiki-light:#59873A;--shiki-dark:#80A665"><v-menu class="twoslash-hover" popper-class="shiki twoslash-floating vp-copy-ignore vp-code" theme="twoslash"><span>defineThemeConfig</span><template v-slot:popper="&#123;}"><span class="twoslash-popup-container vp-copy-ignore" v-pre=""><code class="twoslash-popup-code"><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676">function</span><span style="--shiki-light:#59873A;--shiki-dark:#80A665"> defineThemeConfig</span><span style="--shiki-light:#999999;--shiki-dark:#666666">(</span><span style="--shiki-light:#B07D48;--shiki-dark:#BD976A">config</span><span style="--shiki-light:#999999;--shiki-dark:#666666">: </span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994">ThemeConfig</span><span style="--shiki-light:#999999;--shiki-dark:#666666">):</span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994"> ThemeConfig</span></code><div class="twoslash-popup-docs vp-doc" vp-content=""><p>主题配置，在单独的 <code>plume.config.ts</code> 中使用的类型帮助函数</p></div></span></template></v-menu></span><span style="--shiki-light:#999999;--shiki-dark:#666666">(&#123;</span></span>
<span class="line"><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD">  // 主题配置</span></span>
<span class="line"><span style="--shiki-light:#999999;--shiki-dark:#666666">})</span></span></code></pre>
</div></template></CodeTabs><h2 id="基础配置" tabindex="-1"><a class="header-anchor" href="#基础配置"><span>基础配置</span></a></h2>
...
<p>自定义主题配置文件的路径。</p>
<p>查看 <RouteLink to="/notes/theme/config/intro.html#%E4%B8%BB%E9%A2%98%E9%85%8D%E7%BD%AE%E6%96%87%E4%BB%B6">主题配置文件 <code v-pre>plume.config.js</code></RouteLink> 了解更多。</p>
<div class="hint-container warning">
<p class="hint-container-title">该字段不支持在 <RouteLink to="/notes/theme/config/intro.html#%E4%B8%BB%E9%A2%98%E9%85%8D%E7%BD%AE%E6%96%87%E4%BB%B6">主题配置文件 <code v-pre>plume.config.js</code></RouteLink> 中进行配置。</p>
</div>
</li>
...
<ul>
<li>
<p><strong>类型：</strong><code v-pre>PlumeThemePluginOptions</code></p>
</li>
<li>
<p><strong>默认值：</strong> <code v-pre>{}</code></p>
</li>
...
<RouteLink to="/notes/theme/config/plugins/">此文档</RouteLink></p>
<div class="hint-container warning">
<p class="hint-container-title">该字段不支持在 <RouteLink to="/notes/theme/config/intro.html#%E4%B8%BB%E9%A2%98%E9%85%8D%E7%BD%AE%E6%96%87%E4%BB%B6">主题配置文件 <code v-pre>plume.config.js</code></RouteLink> 中进行配置。</p>
</div>
</li>
</ul>
<h3 id="markdown" tabindex="-1"><a class="header-anchor" href="#markdown"><span>markdown <Badge type="tip" text="1.0.0-rc.136 +" /></span></a></h3>
<ul>
<li>
<p><strong>类型：</strong> <code v-pre>MarkdownOptions</code></p>
</li>
<li>
<p><strong>默认值：</strong> <code v-pre>{}</code></p>
</li>
<li>
<p><strong>详情：</strong></p>
<p>Markdown 功能配置， 参考 <RouteLink to="/notes/theme/config/markdown.html">此文档</RouteLink></p>
<div class="hint-container warning">
<p class="hint-container-title">该字段不支持在 <RouteLink to="/notes/theme/config/intro.html#%E4%B8%BB%E9%A2%98%E9%85%8D%E7%BD%AE%E6%96%87%E4%BB%B6">主题配置文件 <code v-pre>plume.config.js</code></RouteLink> 中进行配置。</p>
</div>
</li>
</ul>
<h3 id="codehighlighter" tabindex="-1"><a class="header-anchor" href="#codehighlighter"><span>codeHighlighter <Badge type="tip" text="1.0.0-rc.136 +" /></span></a></h3>
<ul>
<li>
<p><strong>类型：</strong> <code v-pre>false | ShikiPluginOptions</code></p>
</li>
<li>
<p><strong>默认值：</strong> <code v-pre>{}</code></p>
</li>
<li>
<p><strong>详情：</strong></p>
<p>代码高亮配置， 参考 <RouteLink to="/notes/theme/guide/code/intro.html">此文档</RouteLink></p>
<div class="hint-container warning">
<p class="hint-container-title">该字段不支持在 <RouteLink to="/notes/theme/config/intro.html#%E4%B8%BB%E9%A2%98%E9%85%8D%E7%BD%AE%E6%96%87%E4%BB%B6">主题配置文件 <code v-pre>plume.config.js</code></RouteLink> 中进行配置。</p>
</div>
</li>
</ul>
<h3 id="search" tabindex="-1"><a class="header-anchor" href="#search"><span>search <Badge type="tip" text="1.0.0-rc.136 +" /></span></a></h3>
<ul>
<li>
<p><strong>类型：</strong> <code v-pre>false | SearchOptions</code></p>
</li>
<li>
<p><strong>默认值：</strong> <code v-pre>{ provider: 'local' }</code></p>
</li>
<li>
<p><strong>详情：</strong></p>
<p>搜索配置， 参考 <RouteLink to="/notes/theme/guide/features/search.html">此文档</RouteLink></p>
<div class="hint-container warning">
<p class="hint-container-title">该字段不支持在 <RouteLink to="/notes/theme/config/intro.html#%E4%B8%BB%E9%A2%98%E9%85%8D%E7%BD%AE%E6%96%87%E4%BB%B6">主题配置文件 <code v-pre>plume.config.js</code></RouteLink> 中进行配置。</p>
</div>
</li>
</ul>
<h3 id="comment" tabindex="-1"><a class="header-anchor" href="#comment"><span>comment <Badge type="tip" text="1.0.0-rc.136 +" /></span></a></h3>
<ul>
<li>
<p><strong>类型：</strong> <code v-pre>false | CommentPluginOptions</code></p>
</li>
<li>
<p><strong>默认值：</strong> <code v-pre>false</code></p>
</li>
<li>
<p><strong>详情：</strong></p>
<p>评论配置， 参考 <RouteLink to="/notes/theme/guide/features/comments.html">此文档</RouteLink></p>
<div class="hint-container warning">
<p class="hint-container-title">该字段不支持在 <RouteLink to="/notes/theme/config/intro.html#%E4%B8%BB%E9%A2%98%E9%85%8D%E7%BD%AE%E6%96%87%E4%BB%B6">主题配置文件 <code v-pre>plume.config.js</code></RouteLink> 中进行配置。</p>
</div>
</li>
</ul>
<h3 id="watermark" tabindex="-1"><a class="header-anchor" href="#watermark"><span>watermark <Badge type="tip" text="1.0.0-rc.136 +" /></span></a></h3>
<ul>
<li>
<p><strong>类型：</strong> <code v-pre>false | WatermarkPluginOptions</code></p>
</li>
<li>
<p><strong>默认值：</strong> <code v-pre>false</code></p>
</li>
<li>
<p><strong>详情：</strong></p>
<p>水印配置， 参考 <RouteLink to="/notes/theme/guide/features/watermark.html">此文档</RouteLink></p>
<div class="hint-container warning">
<p class="hint-container-title">该字段不支持在 <RouteLink to="/notes/theme/config/intro.html#%E4%B8%BB%E9%A2%98%E9%85%8D%E7%BD%AE%E6%96%87%E4%BB%B6">主题配置文件 <code v-pre>plume.config.js</code></RouteLink> 中进行配置。</p>
</div>
</li>
</ul>
<h3 id="readingtime" tabindex="-1"><a class="header-anchor" href="#readingtime"><span>readingTime <Badge type="tip" text="1.0.0-rc.136 +" /></span></a></h3>
<ul>
<li>
<p><strong>类型：</strong> <code v-pre>false | ReadingTimePluginOptions</code></p>
</li>
<li>
<p><strong>默认值：</strong> <code v-pre>false</code></p>
</li>
<li>
<p><strong>详情：</strong></p>
<p>阅读时长配置， 参考 <RouteLink to="/notes/theme/guide/features/reading-time.html">此文档</RouteLink></p>
<div class="hint-container warning">
<p class="hint-container-title">该字段不支持在 <RouteLink to="/notes/theme/config/intro.html#%E4%B8%BB%E9%A2%98%E9%85%8D%E7%BD%AE%E6%96%87%E4%BB%B6">主题配置文件 <code v-pre>plume.config.js</code></RouteLink> 中进行配置。</p>
</div>
</li>
</ul>
<h3 id="copycode" tabindex="-1"><a class="header-anchor" href="#copycode"><span>copyCode <Badge type="tip" text="1.0.0-rc.136 +" /></span></a></h3>
<ul>
<li>
<p><strong>类型：</strong> <code v-pre>false | CopyCodePluginOptions</code></p>
</li>
<li>
<p><strong>默认值：</strong> <code v-pre>{}</code></p>
</li>
<li>
<p><strong>详情：</strong></p>
<p>复制代码配置， 参考 <RouteLink to="/notes/theme/guide/features/copy-code.html">此文档</RouteLink></p>
<div class="hint-container warning">
<p class="hint-container-title">该字段不支持在 <RouteLink to="/notes/theme/config/intro.html#%E4%B8%BB%E9%A2%98%E9%85%8D%E7%BD%AE%E6%96%87%E4%BB%B6">主题配置文件 <code v-pre>plume.config.js</code></RouteLink> 中进行配置。</p>
</div>
</li>
</ul>
<h3 id="replaceassets" tabindex="-1"><a class="header-anchor" href="#replaceassets"><span>replaceAssets <Badge type="tip" text="1.0.0-rc.139 +" /></span></a></h3>
<ul>
<li>
<p><strong>类型：</strong> <code v-pre>false | ReplaceAssetsPluginOptions</code></p>
</li>
<li>
<p><strong>默认值：</strong> <code v-pre>false</code></p>
</li>
<li>
<p><strong>详情：</strong></p>
<p>替换资源配置， 参考 <RouteLink to="/notes/theme/guide/features/replace-assets.html">此文档</RouteLink></p>
<div class="hint-container warning">
<p class="hint-container-title">该字段不支持在 <RouteLink to="/notes/theme/config/intro.html#%E4%B8%BB%E9%A2%98%E9%85%8D%E7%BD%AE%E6%96%87%E4%BB%B6">主题配置文件 <code v-pre>plume.config.js</code></RouteLink> 中进行配置。</p>
</div>
</li>
...
<ul>
<li>
<p><strong>类型：</strong> <code v-pre>false | BlogOptions</code></p>
</li>
<li>
<p><strong>默认值：</strong> <code v-pre>{ link: '/blog/',  include: ['**/*.md'], exclude: [] }</code></p>
</li>
<li>
<p><strong>详情：</strong></p>
<p>博客配置。</p>
...
<div class="language-ts line-numbers-mode" data-highlighter="shiki" data-ext="ts" style="--shiki-light:#393a34;--shiki-dark:#dbd7caee;--shiki-light-bg:#ffffff;--shiki-dark-bg:#121212"><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code" v-pre=""><code><span class="line"><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676">interface</span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994"> BlogOptions</span><span style="--shiki-light:#999999;--shiki-dark:#666666"> {</span></span>
...
<span class="line"><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD">   */</span></span>
<span class="line"><span style="--shiki-light:#B07D48;--shiki-dark:#BD976A">  postCover</span><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676">?</span><span style="--shiki-light:#999999;--shiki-dark:#666666">: </span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994">BlogPostCoverLayout</span><span style="--shiki-light:#999999;--shiki-dark:#666666"> | </span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994">BlogPostCoverStyle</span></span>
<span class="line"><span style="--shiki-light:#999999;--shiki-dark:#666666">}</span></span>
<span class="line"></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676">interface</span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994"> BlogPostCoverStyle</span><span style="--shiki-light:#999999;--shiki-dark:#666666"> {</span></span>
<span class="line"><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD">  /**</span></span>
...
<li>
<p><strong>默认值：</strong> <code v-pre>/article/</code></p>
</li>
<li>
<p><strong>详情：</strong> 文章链接前缀</p>
<div class="hint-container warning">
<p class="hint-container-title">该字段不支持在 <RouteLink to="/notes/theme/config/intro.html#%E4%B8%BB%E9%A2%98%E9%85%8D%E7%BD%AE%E6%96%87%E4%BB%B6">主题配置文件 <code v-pre>plume.config.js</code></RouteLink> 中进行配置。</p>
</div>
</li>
...
<ul>
<li>
<p><strong>类型：</strong> <code v-pre>false | AutoFrontmatterOptions</code></p>
</li>
<li>
<p><strong>详情：</strong></p>
<p>是否为 markdown 文件自动添加 frontmatter 配置</p>
<div class="language-ts line-numbers-mode" data-highlighter="shiki" data-ext="ts" style="--shiki-light:#393a34;--shiki-dark:#dbd7caee;--shiki-light-bg:#ffffff;--shiki-dark-bg:#121212"><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code" v-pre=""><code><span class="line"><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676">interface</span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994"> AutoFrontmatterOptions</span><span style="--shiki-light:#999999;--shiki-dark:#666666"> {</span></span>
<span class="line"><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD">  /**</span></span>
...
<ul>
<li>
<p><strong>类型：</strong> <code v-pre>false | 'memory' | 'filesystem'</code></p>
</li>
<li>
<p><strong>默认值：</strong> <code v-pre>filesystem</code></p>
</li>
<li>
<p><strong>详情：</strong></p>
...
<p>该字段不支持在 <RouteLink to="/notes/theme/config/intro.html#%E4%B8%BB%E9%A2%98%E9%85%8D%E7%BD%AE%E6%96%87%E4%BB%B6">主题配置文件 <code v-pre>plume.config.js</code></RouteLink> 中进行配置。</p>
...
<li><strong>详情：</strong> 文档仓库配置, 用于生成 <code v-pre>Edit this page</code> 链接。</li>
</ul>
<h3 id="docsbranch" tabindex="-1"><a class="header-anchor" href="#docsbranch"><span>docsBranch</span></a></h3>
<ul>
<li><strong>类型：</strong> <code v-pre>string</code></li>
<li><strong>默认值：</strong> <code v-pre>''</code></li>
<li><strong>详情：</strong> 文档仓库分支配置，用于生成 <code v-pre>Edit this page</code> 链接。</li>
</ul>
<h3 id="docsdir" tabindex="-1"><a class="header-anchor" href="#docsdir"><span>docsDir</span></a></h3>
<ul>
<li><strong>类型：</strong> <code v-pre>string</code></li>
<li><strong>默认值：</strong> <code v-pre>''</code></li>
<li><strong>详情：</strong> 文档仓库目录配置，用于生成 <code v-pre>Edit this page</code> 链接。</li>
</ul>
<h3 id="editlink" tabindex="-1"><a class="header-anchor" href="#editlink"><span>editLink</span></a></h3>
<ul>
<li>
<p><strong>类型：</strong> <code v-pre>boolean</code></p>
</li>
<li>
<p><strong>默认值：</strong> <code v-pre>true</code></p>
</li>
<li>
<p><strong>详情：</strong> 是否启用 编辑链接</p>
<div class="hint-container warning">
<p class="hint-container-title">该字段不支持在 <RouteLink to="/notes/theme/config/intro.html#%E4%B8%BB%E9%A2%98%E9%85%8D%E7%BD%AE%E6%96%87%E4%BB%B6">主题配置文件 <code v-pre>plume.config.js</code></RouteLink> 中进行配置。</p>
</div>
</li>
...
<ul>
<li><strong>类型：</strong> <code v-pre>false | LastUpdatedOptions</code></li>
<li><strong>默认值：</strong> <code v-pre>{ formatOptions: { dateStyle: 'short', timeStyle: 'short' } }</code></li>
<li><strong>详情：</strong> 最后更新时间</li>
</ul>
<div class="language-ts line-numbers-mode" data-highlighter="shiki" data-ext="ts" style="--shiki-light:#393a34;--shiki-dark:#dbd7caee;--shiki-light-bg:#ffffff;--shiki-dark-bg:#121212"><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code" v-pre=""><code><span class="line"><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676">interface</span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994"> LastUpdatedOptions</span><span style="--shiki-light:#999999;--shiki-dark:#666666"> {</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD">  /**</span></span>
...
<ul>
<li>
<p><strong>类型：</strong> <code v-pre>boolean | ContributorsOptions</code></p>
</li>
<li>
<p><strong>默认值：</strong> <code v-pre>true</code></p>
</li>
<li>
<p><strong>详情：</strong> 是否显示贡献者</p>
<p>更多配置请参考 <RouteLink to="/notes/theme/guide/features/contributors.html">此文档</RouteLink></p>
<div class="hint-container warning">
<p class="hint-container-title">该字段不支持在 <RouteLink to="/notes/theme/config/intro.html#%E4%B8%BB%E9%A2%98%E9%85%8D%E7%BD%AE%E6%96%87%E4%BB%B6">主题配置文件 <code v-pre>plume.config.js</code></RouteLink> 中进行配置。</p>
</div>
</li>
...
<ul>
<li>
<p><strong>类型：</strong> <code v-pre>boolean | ChangelogOptions</code></p>
</li>
<li>
<p><strong>默认值：</strong> <code v-pre>false</code></p>
</li>
<li>
<p><strong>详情：</strong> 是否显示页面变更历史</p>
<p>更多配置请参考 <RouteLink to="/notes/theme/guide/features/changelog.html">此文档</RouteLink></p>
<div class="hint-container warning">
<p class="hint-container-title">该字段不支持在 <RouteLink to="/notes/theme/config/intro.html#%E4%B8%BB%E9%A2%98%E9%85%8D%E7%BD%AE%E6%96%87%E4%BB%B6">主题配置文件 <code v-pre>plume.config.js</code></RouteLink> 中进行配置。</p>
</div>
</li>
...
<ul>
<li><strong>类型：</strong> <code v-pre>Record&lt;string, ThemeLocaleData&gt;</code></li>
<li><strong>默认值：</strong> <code v-pre>{}</code></li>
<li><strong>详情：</strong> 多语言配置</li>
</ul>
<p>不同语言的文本配置，参考 <RouteLink to="/notes/theme/config/locales.html">此文档</RouteLink></p>
<p>多语言配置支持以下 <a href="#locale-%E9%85%8D%E7%BD%AE">Locale</a> 所有配置选项以控制不同语言下的主题行为。</p>
<h2 id="locale-配置" tabindex="-1"><a class="header-anchor" href="#locale-配置"><span>Locale 配置</span></a></h2>
<div class="hint-container tip">
<p class="hint-container-title">以下所有字段也均是基础配置字段，可以与 <code v-pre>locales</code> 等字段平级配置。</p>
</div>
<h3 id="home" tabindex="-1"><a class="header-anchor" href="#home"><span>home</span></a></h3>
<ul>
<li><strong>类型：</strong> <code v-pre>false | string</code></li>
<li><strong>默认值：</strong> <code v-pre>/</code></li>
<li><strong>详情：</strong>
首页的路径， 它将被用于：
<ul>
...
<li><strong>详情：</strong> 导航栏中的logo。</li>
</ul>
<h3 id="logodark" tabindex="-1"><a class="header-anchor" href="#logodark"><span>logoDark</span></a></h3>
<ul>
<li>类型 <code v-pre>false | string</code></li>
<li><strong>默认值：</strong> <code v-pre>false</code></li>
<li><strong>详情：</strong> Dark模式下，导航栏中的logo。</li>
</ul>
<h3 id="appearance" tabindex="-1"><a class="header-anchor" href="#appearance"><span>appearance</span></a></h3>
<ul>
<li><strong>类型：</strong> <code v-pre>boolean | 'dark' | 'force-dark</code></li>
<li><strong>默认值：</strong> <code v-pre>true</code></li>
</ul>
<p>是否启用 深色模式。</p>
<ul>
...
<ul>
<li><strong>类型：</strong> <code v-pre>ProfileOptions</code></li>
<li><strong>默认值：</strong> <code v-pre>{}</code></li>
<li>**详情：**配置站点博主的个人信息
<ul>
...
<p>示例：</p>
<div class="language-ts line-numbers-mode" data-highlighter="shiki" data-ext="ts" style="--shiki-light:#393a34;--shiki-dark:#dbd7caee;--shiki-light-bg:#ffffff;--shiki-dark-bg:#121212"><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code" v-pre=""><code><span class="line"><span style="--shiki-light:#1E754F;--shiki-dark:#4D9375">export</span><span style="--shiki-light:#1E754F;--shiki-dark:#4D9375"> default</span><span style="--shiki-light:#59873A;--shiki-dark:#80A665"> defineUserConfig</span><span style="--shiki-light:#999999;--shiki-dark:#666666">({</span></span>
...
<ul>
<li>
<p><strong>类型：</strong> <code v-pre>false | SocialLink[]</code></p>
</li>
<li>
<p><strong>默认值：</strong> <code v-pre>false</code></p>
</li>
<li>
<p><strong>详情：</strong> 个人社交信息配置。</p>
...
<span class="line"><span style="--shiki-light:#999999;--shiki-dark:#666666">  })</span></span>
<span class="line"><span style="--shiki-light:#999999;--shiki-dark:#666666">})</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="navbarsocialinclude" tabindex="-1"><a class="header-anchor" href="#navbarsocialinclude"><span>navbarSocialInclude</span></a></h3>
<ul>
<li>
<p><strong>类型：</strong> <code v-pre>string[]</code></p>
</li>
<li>
<p><strong>默认值：</strong> <code v-pre>['github', 'twitter', 'discord', 'facebook']</code></p>
</li>
<li>
<p><strong>详情：</strong></p>
<p>允许显示在导航栏的社交链接。
...
<ul>
<li>
<p><strong>类型：</strong> <code v-pre>NavItem[]</code></p>
</li>
<li>
<p><strong>默认值：</strong> <code v-pre>[]</code></p>
</li>
<li>
<p><strong>详情：</strong> 导航栏配置。</p>
...
<div class="language-ts line-numbers-mode" data-highlighter="shiki" data-ext="ts" style="--shiki-light:#393a34;--shiki-dark:#dbd7caee;--shiki-light-bg:#ffffff;--shiki-dark-bg:#121212"><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code" v-pre=""><code><span class="line"><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676">type</span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994"> NavItem</span><span style="--shiki-light:#999999;--shiki-dark:#666666"> =</span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994"> string</span><span style="--shiki-light:#999999;--shiki-dark:#666666"> |</span><span style="--shiki-light:#999999;--shiki-dark:#666666"> {</span></span>
...
<li>
<p>示例1：</p>
<div class="language-js line-numbers-mode" data-highlighter="shiki" data-ext="js" style="--shiki-light:#393a34;--shiki-dark:#dbd7caee;--shiki-light-bg:#ffffff;--shiki-dark-bg:#121212"><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code" v-pre=""><code><span class="line"><span style="--shiki-light:#1E754F;--shiki-dark:#4D9375">export</span><span style="--shiki-light:#1E754F;--shiki-dark:#4D9375"> default</span><span style="--shiki-light:#59873A;--shiki-dark:#80A665"> defineUserConfig</span><span style="--shiki-light:#999999;--shiki-dark:#666666">({</span></span>
<span class="line"><span style="--shiki-light:#998418;--shiki-dark:#B8A965">  theme</span><span style="--shiki-light:#999999;--shiki-dark:#666666">:</span><span style="--shiki-light:#59873A;--shiki-dark:#80A665"> plumeTheme</span><span style="--shiki-light:#999999;--shiki-dark:#666666">({</span></span>
...
<ul>
<li>
<p><strong>类型：</strong> <code v-pre>false | NotesOptions</code></p>
</li>
<li>
<p><strong>默认值：</strong> <code v-pre>{ link: '/note', dir: 'notes', notes: [] }</code></p>
</li>
<li>
<p><strong>详情：</strong></p>
...
<p>详细配置请查看 <RouteLink to="/notes/theme/config/notes.html">此文档</RouteLink></p>
<h3 id="sidebar" tabindex="-1"><a class="header-anchor" href="#sidebar"><span>sidebar</span></a></h3>
<ul>
<li>
<p><strong>类型：</strong> <code v-pre>false | SidebarMulti</code></p>
</li>
<li>
<p><strong>详情：</strong></p>
<p>侧边栏配置。<strong>主题更推荐在 <RouteLink to="/notes/theme/config/notes.html">notes 配置</RouteLink> 中进行侧边栏配置。</strong></p>
...
<li>
<p><strong>详情：</strong> 是否显示侧边栏滚动条</p>
<p>设置为 <code v-pre>false</code> 时，仅隐藏滚动条，但不改变滚动行为。</p>
</li>
</ul>
<h3 id="aside" tabindex="-1"><a class="header-anchor" href="#aside"><span>aside</span></a></h3>
<ul>
<li>
<p><strong>类型：</strong> <code v-pre>boolean | 'left'</code></p>
</li>
<li>
<p><strong>默认值：</strong> <code v-pre>true</code></p>
</li>
...
<p>每个页面可以通过 <RouteLink to="/notes/theme/config/frontmatter/basic.html#aside">frontmatter aside</RouteLink> 覆盖层级配置。</p>
</li>
</ul>
<h3 id="outline" tabindex="-1"><a class="header-anchor" href="#outline"><span>outline</span></a></h3>
<ul>
<li>
<p><strong>类型：</strong> <code v-pre>false | number | [number, number] | 'deep'</code></p>
</li>
<li>
<p><strong>默认值：</strong> <code v-pre>[2, 3]</code></p>
</li>
<li>
<p><strong>详情：</strong></p>
<p>要显示的标题级别。</p>
...
<p>每个页面可以通过 <RouteLink to="/notes/theme/config/frontmatter/basic.html#outline">frontmatter outline</RouteLink> 覆盖层级配置。</p>
</li>
</ul>
<h3 id="transition" tabindex="-1"><a class="header-anchor" href="#transition"><span>transition</span></a></h3>
<ul>
<li>
<p><strong>类型：</strong> <code v-pre>boolean | TransitionOptions</code></p>
</li>
<li>
<p><strong>默认值：</strong> <code v-pre>true</code></p>
</li>
...
<div class="language-ts line-numbers-mode" data-highlighter="shiki" data-ext="ts" style="--shiki-light:#393a34;--shiki-dark:#dbd7caee;--shiki-light-bg:#ffffff;--shiki-dark-bg:#121212"><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code" v-pre=""><code><span class="line"><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676">interface</span><span style="--shiki-light:#2E8F82;--shiki-dark:#5DA994"> TransitionOptions</span><span style="--shiki-light:#999999;--shiki-dark:#666666"> {</span></span>
<span class="line"><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD">  /**</span></span>
...
<ul>
<li><strong>类型：</strong> <code v-pre>false | { message: string; copyright: string }</code></li>
<li><strong>默认值：</strong> <code v-pre>false</code></li>
<li>**详情：**页脚配置。</li>
</ul>
...
<ul>
<li>
<p><strong>类型：</strong> <code v-pre>boolean | BulletinOptions</code></p>
</li>
<li>
<p><strong>默认值：</strong> <code v-pre>false</code></p>
</li>
<li>
<p><strong>详情：</strong> 公告板配置</p>
<p>详情请参考 <RouteLink to="/notes/theme/guide/features/bulletin.html">公告板</RouteLink></p>
</li>
</ul>
...
<li>
<p><strong>详情：</strong> 编辑链接的正则表达式</p>
...
<ul>
<li>
<p><strong>类型：</strong> <code v-pre>boolean | CopyrightLicense | CopyrightOptions</code></p>
</li>
<li>
<p><strong>默认值：</strong> <code v-pre>false</code></p>
</li>
<li>
<p><strong>详情：</strong> 版权配置</p>
<p>详情请参考 <RouteLink to="/notes/theme/guide/features/copyright.html">版权所有</RouteLink></p>
</li>
</ul>
